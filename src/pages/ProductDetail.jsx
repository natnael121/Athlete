...
const AthleteProfile = () => {
    ...
    return (
        <motion.div
            ...
            style={{ backgroundColor: '#0A0A0F', minHeight: '100vh', color: 'white' }}
        >
                    ...
                    <div style={{ display: 'grid', gridTemplateColumns: 'minmax(300px, 40%) 1fr', gap: '4rem', alignItems: 'start' }}>
                        ...
                        <div style={{ paddingTop: '1rem' }}>
                            <motion.div initial={{ y: 20, opacity: 0 }} animate={{ y: 0, opacity: 1 }} transition={{ delay: 0.2 }}>
                                ...
                                <h1 style={{ fontSize: '4.5rem', fontWeight: '800', textTransform: 'uppercase', lineHeight: 1, marginBottom: '3rem', letterSpacing: '-0.02em' }}>
