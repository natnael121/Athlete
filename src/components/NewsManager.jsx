        ...
        <div style={{ paddingBottom: '4rem' }}>
            ...
            <div className="card" style={{ padding: '2.5rem' }}>
                <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '2rem' }}>
                    <h3 className="heading-sm" style={{ margin: 0, display: 'flex', alignItems: 'center', gap: '0.75rem' }}>
                ...
                <form onSubmit={handleSubmit} style={{ display: 'grid', gap: '1.5rem' }}>
                    ...
                    <div style={{ display: 'flex', flexDirection: 'column', gap: '0.5rem' }}>
                        <label style={{ fontSize: '0.85rem', fontWeight: '700' }}>Headline / Title</label>
                        <input
                    ...
                    <div style={{ display: 'flex', flexDirection: 'column', gap: '0.5rem' }}>
                        ...
                        <div style={{ display: 'flex', gap: '0.5rem' }}>
                            {!showCategoryInput ? (
                                <>
                                    <select value={category} onChange={(e) => setCategory(e.target.value)} style={{ flex: 1, padding: '0.8rem', borderRadius: '0.5rem', border: '1px solid #E5E7EB' }}>
                                ...
                                <>
                                    <input type="text" placeholder="New category..." value={customCategory} onChange={(e) => setCustomCategory(e.target.value)} style={{ flex: 1, padding: '0.8rem', borderRadius: '0.5rem', border: '1px solid #E5E7EB' }} />
                    ...
                    <div style={{ display: 'flex', flexDirection: 'column', gap: '0.5rem' }}>
                        <label style={{ fontSize: '0.85rem', fontWeight: '700' }}>Featured Image</label>
                        <div
                            style={{ border: '2px dashed #E5E7EB', borderRadius: '1rem', padding: '1.5rem', textAlign: 'center', cursor: 'pointer', backgroundColor: '#F9FAFB' }}
                    ...
                    <div style={{ display: 'flex', flexDirection: 'column', gap: '0.5rem' }}>
                        <label style={{ fontSize: '0.85rem', fontWeight: '700' }}>Post content / Summary</label>
                        <textarea rows="4" required value={excerpt} onChange={(e) => setExcerpt(e.target.value)} placeholder="Content..." style={{ padding: '0.8rem', borderRadius: '0.5rem', border: '1px solid #E5E7EB', resize: 'none' }}></textarea>
                    </div>
            ...
            <div className="card" style={{ marginTop: '3rem', padding: '2.5rem' }}>
                <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '2rem' }}>
                    <h3 className="heading-sm">Manage Existing News</h3>
                ...
                <div style={{ display: 'grid', gap: '1.5rem' }}>
                    {newsPosts.length === 0 ? (
                        <p style={{ color: '#666', fontStyle: 'italic' }}>No news posts found.</p>
                    ) : (
                        newsPosts.map(post => (
                            <div key={post.id} style={{ display: 'flex', gap: '1.5rem', padding: '1rem', border: '1px solid #F3F4F6', borderRadius: '0.75rem', alignItems: 'center' }}>
                                <div style={{ width: '80px', height: '60px', backgroundColor: '#eee', borderRadius: '0.4rem', overflow: 'hidden', flexShrink: 0 }}>
                                    {post.imageUrl && <img src={post.imageUrl} alt="" style={{ width: '100%', height: '100%', objectFit: 'cover' }} />}
                                </div>
                                <div style={{ flex: 1 }}>
                                    <h4 style={{ fontSize: '0.9rem', fontWeight: '700', marginBottom: '0.25rem' }}>{post.title}</h4>
